...
function findTopCustomer(bills) {
    var billsByCustomer = groupBillsByCustomer.descending(bills);
    var topCustomers = [];
    var i = 0;
...
function groupByQuarter(bills) {
    ...
    var byQuarter = groupBills.groupReduceSort(groupBills.byQuarter(minYear),null)(bills);
...
function groupTop5ByQuarter(bills) {
    ...
    var byCustomerQuarter = groupBills.groupReduceSort(
        groupBills.byCustomerQuarter(minYear),
        null
    )(topCustomersBills);
