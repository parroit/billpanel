...
module.exports = function(bills, groupBy, sortBy) {
    return groupBills(groupBy, sortBy)(bills);
};

module.exports.byQuarter = R.curry(function(minYear, bill) {
    return (bill.data.year() - minYear) * 4 + bill.data.quarter();
});

module.exports.byCustomerQuarter = R.curry(function(minYear, bill) {
    return bill.customer + '|' + ((bill.data.year() - minYear) * 4 + bill.data.quarter());
});


module.exports.groupReduceSort = groupReduceSort;
module.exports.mapToGroupRow = mapToGroupRow;
